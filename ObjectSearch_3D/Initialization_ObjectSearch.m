...
function [occMatrix, map3D, voxelStates, ROIsize, sampled_q_orientations, sensorPose, GoalPosition, mapSize,WorkSpace] = ...
         Initialization_ObjectSearch(matPath,situationPath,posesPath,workSpacePath)
   ...
   %Create a vector of the sampled orientations in a 360x360 FoV
    yaw = deg2rad([0,45,90,135]); 
    pitch = deg2rad([0,45,135,180,225,315]);
