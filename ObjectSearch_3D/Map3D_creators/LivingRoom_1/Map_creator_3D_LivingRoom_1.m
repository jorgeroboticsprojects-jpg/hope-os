...
occMatrix = placeBlock(occMatrix, 20, 30, 1, 15, 40, 10); %big sofa bottom
occMatrix = placeBlock(occMatrix, 20, 30, 11, 5, 40, 10); %big sofa back support
...
desks = [
%     31 40 0 1 0;  % Desk at [30,55], horizontal, with monitor
...
shelves = [
       20 1  180  50 55  5 10;   % Left shelf
       1 50  270  30 30  2 8;   % Right shelf
...
save('../../Maps_ROI_Object_Situations/LivingRoom_1_situations/LivingRoom_1OccMatrix.mat','occMatrix');
disp('saved as LivingRoom_1OccMatrix.mat ')

%% Save WorkSpace
save('../../Maps_ROI_Object_Situations/LivingRoom_1_situations/LivingRoom_1WorkSpace.mat','WorkSpace');
disp('saved as LivingRoom_1WorkSpace.mat ')
