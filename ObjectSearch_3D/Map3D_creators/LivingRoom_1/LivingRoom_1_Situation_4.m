...
%% DEFINE ROI SETTINGS
voxelStates(1:17, 49:80, 1:35) = 4;

%% DEFINE OBJECTIVE LOCATION
objectX=3; objectY=52; objectZ=16;
...
save('../../Maps_ROI_Object_Situations/LivingRoom_1_situations/LivingRoom_1_voxelStates_4.mat','voxelStates');
