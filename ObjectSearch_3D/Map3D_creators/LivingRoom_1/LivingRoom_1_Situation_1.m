...
%% DEFINE ROI SETTINGS
voxelStates(10:67, 1:15, 1:40) = 4;

%% DEFINE OBJECTIVE LOCATION
objectX=22; objectY=3; objectZ=12;
...
save('../../Maps_ROI_Object_Situations/LivingRoom_1_situations/LivingRoom_1_voxelStates_1.mat','voxelStates');
