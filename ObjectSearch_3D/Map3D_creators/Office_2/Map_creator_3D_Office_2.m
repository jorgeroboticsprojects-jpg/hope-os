...
chairs = [
    41 27 180;    % Chair just behind the desk
    %68 66 90
];

% Format: [x, y, rotation, width, height, levels, depth]
shelves = [
     46 60 270  30 50  4 10;   % Left shelf
     36 60  90  30 50  4 10;   % Right shelf
...
save('../../Maps_ROI_Object_Situations/Office_2_situations/Office_2OccMatrix.mat','occMatrix');
disp('saved as Office_2OccMatrix.mat ')

%% Save WorkSpace
save('../../Maps_ROI_Object_Situations/Office_2_situations/Office_2WorkSpace.mat','WorkSpace');
