...
%% DEFINE ROI SETTINGS
voxelStates(1:20, 45:83, 1:45) = 4;

%% DEFINE OBJECTIVE LOCATION
objectX=3; objectY=77; objectZ=12;
...
save('../../Maps_ROI_Object_Situations/Office_1_situations/Office_1_voxelStates_2.mat','voxelStates');
