...
%% DEFINE ROI SETTINGS
voxelStates(73:89, 1:20, 1:45) = 4;

%% DEFINE OBJECTIVE LOCATION
objectX=80; objectY=10; objectZ=3;
...
save('../../Maps_ROI_Object_Situations/Office_1_situations/Office_1_voxelStates_3.mat','voxelStates');
