...
%% DEFINE ROI SETTINGS
voxelStates(1:15, 45:83, 1:63) = 4;

%% DEFINE OBJECTIVE LOCATION
objectX=3; objectY=52; objectZ=30;
...
save('../../Maps_ROI_Object_Situations/Office_1_situations/Office_1_voxelStates_1.mat','voxelStates');
