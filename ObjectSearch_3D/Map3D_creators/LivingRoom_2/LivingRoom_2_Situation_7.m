...
%% DEFINE ROI SETTINGS
voxelStates(80:90, 1:45, 2:22) = 4;

%% DEFINE OBJECTIVE LOCATION
objectX=87; objectY=9; objectZ=7;
...
save('../../Maps_ROI_Object_Situations/LivingRoom_2_situations/LivingRoom_2_voxelStates_7.mat','voxelStates');
