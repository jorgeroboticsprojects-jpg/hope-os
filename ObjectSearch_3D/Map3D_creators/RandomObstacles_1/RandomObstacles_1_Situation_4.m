...
%% DEFINE ROI SETTINGS
voxelStates(1:40, 70:88, 1:30) = 4;

%% DEFINE OBJECTIVE LOCATION
objectX=3; objectY=86; objectZ=15;
...
save('../../Maps_ROI_Object_Situations/RandomObstacles_1_situations/RandomObstacles_1_voxelStates_4.mat','voxelStates');
disp('saved voxelStates_4.mat')