...
%% DEFINE ROI SETTINGS
voxelStates(68:90, 1:25, 1:40) = 4;

%% DEFINE OBJECTIVE LOCATION
objectX=83; objectY=8; objectZ=27;
...
save('../../Maps_ROI_Object_Situations/RandomObstacles_1_situations/RandomObstacles_1_voxelStates_5.mat','voxelStates');
disp('saved voxelStates_5.mat')