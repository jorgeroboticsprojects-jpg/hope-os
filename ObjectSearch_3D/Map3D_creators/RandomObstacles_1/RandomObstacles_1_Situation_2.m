...
%% DEFINE ROI SETTINGS
voxelStates(9:43, 5:18, 1:33) = 4;

%% DEFINE OBJECTIVE LOCATION
objectX=35; objectY=13; objectZ=3;
...
save('../../Maps_ROI_Object_Situations/RandomObstacles_1_situations/RandomObstacles_1_voxelStates_2.mat','voxelStates');
disp('saved voxelStates_2.mat')