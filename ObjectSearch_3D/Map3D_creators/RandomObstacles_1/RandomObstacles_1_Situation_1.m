...
%% DEFINE ROI SETTINGS
voxelStates(30:49, 30:49, 1:35) = 4;

%% DEFINE OBJECTIVE LOCATION
objectX=36; objectY=44; objectZ=20;
...
scatter3(rx-0.5, ry-0.5, rz-0.5, 50, [1, 0.8, 0], 'filled', 'MarkerFaceAlpha', 0.5);
...
save('../../Maps_ROI_Object_Situations/RandomObstacles_1_situations/RandomObstacles_1_voxelStates_1.mat','voxelStates');
disp('saved voxelStates_1.mat')