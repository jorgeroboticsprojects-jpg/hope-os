...
%% DEFINE ROI SETTINGS
voxelStates(5:35, 1:30, 1:35) = 4;

%% DEFINE OBJECTIVE LOCATION
objectX=16; objectY=13; objectZ=3;
...
save('../../Maps_ROI_Object_Situations/RandomObstacles_2_situations/RandomObstacles_2_voxelStates_1.mat','voxelStates');
