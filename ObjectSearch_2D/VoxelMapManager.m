classdef VoxelMapManager 
    ...
    methods (Static)    
        ...
        function voxelStates = updateMap(voxelStates,sensorPose,maxrange,numRaysXY, numRaysZ,...
            ...
            % Apply rounding based on quadrant for each coord
            ...
            % Compute distance drom intersection point to sensor
            ...
            % genereta step vector
            maxSteps = ceil(max(distances) / 0.5); 
            t = (0:0.5:(maxSteps * 0.5))'; % Vector de paso en 3D a lo largo del rayo
            
            % Compute directions
            dirVectors = intersectionPts - sensorPose(1:3); % Resta de cada punto de intersección con el sensor
            ...
            if ArrowPlotting==1
                    ...
                    direction = rotm(:, 1);         % Obtain riection vector
                    % Sclae direction to deired range
